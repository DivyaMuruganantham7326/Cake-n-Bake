...
$(function () {
    ...
    function navigateUsers() {
        ...
        for (var i = 0; i < userlist.length; i++) {
            ...
            else if (username == userlist[i].userName && userlist[i].newSignin == 1) {
...
function createCompanylist() {
    ...
    var company2 = new company("Three Brothers Bakery", "rachel@uhcl.edu", "654-378-9089", "Rachel", "1300, Dairy Ashford, Katy", "Houston", "TX", "USA", "77089", "buyer");
    var company3 = new company("Kroger Bakery", "geller@uhcl.edu", "789-567-7789", "Geller", "2500, Bay Area Blvd, Clear Lake", "Chicago", "IL", "USA", "77055", "buyer");
    var company4 = new company("Macrina Bakery", "joey@uhcl.edu", "765-789-4569", "Joey", "Dairy Ashford", "New Orleans", "NM", "USA", "667845678", "supplier");
    var company5 = new company("Pearl Bakery", "chandler@uhcl.edu", "789-678-5678", "Chandler", "Katy", "Flagstaff", "AZ", "USA", "786589967", "supplier");
    var company6 = new company("Arandas Bakery", "ross@uhcl.edu", "655-879-7890", "Ross", "Memorial", "Las Vegas", "NV", "USA", "765890788", "buyer");
...
function createproductlist() {
    ...
    supplierlist = ["Cake n Bake", "Kroger Bakery", "Arandas Bakery", "Macrina Bakery", "Three Brothers Bakery", "Pearl Bakery"];
    
    for (i = productlist.length+1; i <= 100; i++) {
        var newproduct = new product("<img class=\"productimg\" src=\"img/cookies.PNG\">", "p" + i, "Auto name " + i, "Auto description " + i, Math.floor((Math.random() * 50) + 1), Math.floor((Math.random() * 100) + 1), supplierlist[Math.floor(Math.random() * supplierlist.length)]);
